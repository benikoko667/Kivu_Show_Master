                ...
                <div class="liste_publications">
                    ...
                    <?php 
                        if(isset($_POST['bt_recherche'])){
                            ...
                            $reponses = AfficherErreurAuthentificationSelonCritaire($type, $mc);
                        }
                        else{
                            $reponses = AfficherErreurAuthentification();
                        }

                        foreach($reponses as $LErreus):
                    ?>

                        <div class= "publication_message">
                            <p>Email utilisé : <?= $LErreus->email_utiliser; ?><br/></p>
                            <p>Password utilisé : <?= $LErreus->password_utiliser; ?><br/></p>
                            <p>Date tentative : <?= $LErreus->date_tentative; ?><br/></p>
                            <p>Terminal utilisé : <?= $LErreus->terminal; ?><br/></p>
                        </div>
