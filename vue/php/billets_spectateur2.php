        ...
        ?>
            <div class="description" id="description">
                ...
                <div class="boite_bouton">
                    ...
                    ?>
                      <a href="presentation_billet.php" class="btn1">Recuperer</a>
                </div>
            </div>
                ...
                <div class="liste_publications">
                    ...
                    <?php 
                        if(isset($_POST['bt_recherche'])){
                            ...
                            // $spectacles = AfficherMesBilletsSelonCritaire($type, $mc, $_SESSION['id']);
                        }
                        else{
                                ...
                                <div class="image">
                                    ...
                                    <div class="operation">
                                        <form name="action sur publication" method="post" action="../../controler/actions/action_billet.php">
                                            ...
                                            <input class="btn_publication1" type="submit" name="bt_presentation" value="Presenter (QR_Code)"/> 
                                        </form>
                                    </div>
                                </div>
                            </div>
